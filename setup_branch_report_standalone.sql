-- Standalone setup for branch report functionality
-- This script can be run directly in Supabase SQL editor

-- PART 1: Check and add missing columns to branch_collection_performance
DO $$
BEGIN
...
-- PART 4: Insert sample performance data
DO $$
DECLARE

-- Fix Collection Overview with correct schema types
...
SELECT 
    ...
    ROUND(RANDOM() * 1000000 + 500000, 2) as total_portfolio_value,
    ROUND(RANDOM() * 100000 + 50000, 2) as total_collected,
    ROUND(RANDOM() * 30 + 70, 2) as collection_rate,
    ...
    ROUND(RANDOM() * 30 + 60, 2) as contact_rate,
    FLOOR(RANDOM() * 50 + 20)::INTEGER as total_ptps,
    FLOOR(RANDOM() * 40 + 10)::INTEGER as ptps_kept,
    ROUND(RANDOM() * 30 + 60, 2) as ptp_keep_rate,
    ROUND(RANDOM() * 60 + 30, 2) as avg_response_time

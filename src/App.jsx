...
import ExecutiveDashboardComprehensive from './pages/ExecutiveDashboardComprehensive';
    ...
    <RTLWrapper className="app min-h-screen">
      ...
      <Routes>
        ...
        <Route element={
          ...
          <Route path="/dashboards/executive" element={<ExecutiveDashboardComprehensive />} />

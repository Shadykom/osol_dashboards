  ...
  async getSpecialistLoans(specialistId, filters = {}) {
    try {
      ...
      const transformedLoans = (data || []).map(caseData => ({
        ...
        totalOverdueDays: caseData.kastle_banking?.loan_accounts?.overdue_days || caseData.days_past_due || 0,
        delinquencyBucket: caseData.kastle_collection?.collection_buckets?.bucket_name || this.getDPDBucket(caseData.days_past_due),

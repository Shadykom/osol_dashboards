-- Complete setup for branch report functionality
-- This script creates views and inserts sample data

-- 1. First, run the view creation
...
-- 6. Verify setup
SELECT 'Branch Summary View' as check_item, COUNT(*) as record_count 
FROM kastle_banking.branch_summary_view
UNION ALL
SELECT 'Branch Performance History', COUNT(*) 
FROM kastle_banking.branch_performance_history_view
UNION ALL
SELECT 'Branch Collection Trends', COUNT(*) 
FROM kastle_banking.branch_collection_trends
UNION ALL
SELECT 'Branch Officer Performance', COUNT(*) 
FROM kastle_banking.branch_officer_performance
UNION ALL
SELECT 'Branch Comparison Data', COUNT(*) 

...
-- Insert buckets
INSERT INTO kastle_collection.collection_buckets (bucket_id, bucket_name, bucket_code, min_days, max_days, priority_level) VALUES
    ('BUCKET_1', '1-30 Days', 'B1', 1, 30, 'LOW'),
    ('BUCKET_2', '31-60 Days', 'B2', 31, 60, 'MEDIUM'),
    ('BUCKET_3', '61-90 Days', 'B3', 61, 90, 'HIGH'),
    ('BUCKET_4', '91-120 Days', 'B4', 91, 120, 'CRITICAL'),
    ('BUCKET_5', '120+ Days', 'B5', 121, 9999, 'CRITICAL')

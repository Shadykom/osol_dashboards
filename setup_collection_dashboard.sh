...
run_sql "diagnose_collection_tables.sql" "Diagnostics"

echo ""
echo "2. Creating collection dashboard tables step by step..."
run_sql "create_all_collection_tables_step_by_step.sql" "Create tables"
